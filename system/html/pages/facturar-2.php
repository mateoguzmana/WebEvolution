...
$sql="INSERT INTO  Facturado (Idcliente,Idobra ,Razon, Nit, Direccion, Ciudad, Fechafact, Fechalim, Descripcion, Retencion, ReteICA,Fecha, Usuario)";
$sql.= "VALUES ('$Idcliente','$Obra','$Razon','$Nit','$Direccion','$Ciudad','$Fechafact','$Fechalim','$Descripcion','$Retencion','$ReteICA','$horaactual','$Usuario')";
mysql_query($sql);


$query		="SELECT* FROM Facturado Order by Id ASC" ;

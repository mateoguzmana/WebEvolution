								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Reporte cuentas por cobrar.</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
		...
		var Id=1;
		$.ajax({
  		url: "ajax-reportecobrar.php?FechaFin="+Fin+"&FechaInicio="+Inicio,
  		data: "Id="+Id,
  		type: "get",
  		...
  		$.ajax({
  		url: "sum-datoscobrar.php?FechaFin="+Fin+"&FechaInicio="+Inicio,
  		data: "Id="+Id,
  		type: "get",
  		success: function(data) {

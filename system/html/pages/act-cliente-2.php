...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					$IdUS				=$_REQUEST['Id']; 
					 ...
					 While($rowUSERS	=mysql_fetch_array($resultUSERS))
					 {
						...
						$Hosting 			=$rowUSERS["Hosting"];
						$FechaVence 		=$rowUSERS["FechaVence"];
												...
												<form class="form-horizontal form-validate" role="form" method="post" action="act-cliente-3.php" novalidate>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="text" name="Cedula" id="Cedula" class="form-control" placeholder="Nit/Cédula" value="<?=$Cedula?>">
																</div>
															</div>
														</div>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="text" name="Celular" id="Celular" class="form-control" placeholder="Celular"  value="<?=$Celular?>" onKeyPress="return isNumberKey(event);">
																</div>
															</div>
														</div>
															...
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Observaciones" class="control-label">Observaciones</label>
                                                    			           <textarea name="Observaciones" rows="3" class="form-control" id="Observaciones" placeholder="Observaciones del cliente" onChange="javascript:this.value=this.value.toUpperCase();"><?=$Observaciones?></textarea>
																</div>
															</div>	
														  </div>
													</div>
															...
															<div class="box box-outlined">
																...
																<div class="box-body">
																	<table class="table table-hover">
																		...
																		<tbody id="Hosting">
																			<? 
																			$query1="SELECT * FROM Hosting WHERE Idcliente='$IdUS'";
																			...
																			<tr id="<?=$Count1?>">
																				<td><?=$Count1?></td>
																				<td><input type="text" class="form-control" name="NombreH<?=$Count1?>" id="NombreH<?=$Count1?>" value="<?=$row1['Nombre']?>"></td>
																				<td><input type="text" class="form-control" name="UrlH<?=$Count1?>" id="UrlH<?=$Count1?>" value="<?=$row1['Url']?>"></td>
																				<td><input type="date" step="7" data-date-format="DD MMMM YYYY" class="form-control" name="FechaH<?=$Count1?>" id="FechaH<?=$Count1?>" value="<?=$row1['Fecha']?>"></td>
																				<td><input type="text" class="form-control" name="UsuarioH<?=$Count1?>" id="UsuarioH<?=$Count1?>" value="<?=$row1['Usuario']?>"></td>
																				<td><input type="text" class="form-control" name="ContrasenaH<?=$Count1?>" id="ContrasenaH<?=$Count1?>" value="<?=$row1['Contrasena']?>"></td>
																			</tr>
																			<?}?>
																			<input type="hidden" id="Numero" name="Numero" value="<?=$Count1?>">
																		</tbody>
																	</table>
																</div><!--end .box-body -->
															</div><!--end .box -->
															...
															<div class="box box-outlined">
																...
																<div class="box-body">
																	<table class="table table-hover">
																		...
																		<tbody id="Dominio">
																			<?
																			$query2="SELECT * FROM Dominio WHERE Idcliente='$IdUS'";
																			...
																			<tr id="<?=$Count?>">
																				<td><?=$Count?></td>
																				<td><input type="text" class="form-control" name="NombreD<?=$Count?>" id="NombreD<?=$Count?>" value="<?=$row2['Nombre']?>"></td>
																				<td><input type="text" class="form-control" name="UrlD<?=$Count?>" id="UrlD<?=$Count?>" value="<?=$row2['Url']?>"></td>
																				<td><input type="text" class="form-control" name="ProveedorD<?=$Count?>" id="ProveedorD<?=$Count?>" value="<?=$row2['Proveedor']?>"></td>
																				<td><input type="date" class="form-control" name="FechaD<?=$Count?>" id="FechaD<?=$Count?>" value="<?=$row2['Fecha']?>"></td>
																				<td><input type="text" class="form-control" name="UsuarioD<?=$Count?>" id="UsuarioD<?=$Count?>" value="<?=$row2['Usuario']?>"></td>
																				<td><input type="text" class="form-control" name="ContrasenaD<?=$Count?>" id="ContrasenaD<?=$Count?>" value="<?=$row2['Contrasena']?>"></td>
																			</tr>
																			<?}?><input type="hidden" id="Numero2" name="Numero2" value="<?=$Count?>">
																		</tbody>
																	</table>
																</div><!--end .box-body -->
															</div><!--end .box -->
													...
													<div class="form-group">
														<div class="col-lg-11 col-md-10 col-sm-9">
															...
															<input name="Volver" type="button" class="btn btn-default" value="Volver"  onClick="location.href='act-cliente.php?Idsubmenu=<?=$_REQUEST["Idsubmenu"]?>&Idmenu=<?=$_REQUEST["Idmenu"]?>&Idopcmenu=<?=$_REQUEST["Idopcmenu"]?>'">
														</div>
													</div>

	...
	while ($rowN=mysql_fetch_array($resultN)) {
		...
		$Cuota 			=$rowN["Cuota"];
			...
			if($FechaInicio=$FechaActual){
				...
				$query3.= "VALUES ('1','$Opcion','$Idobra','$Idcliente','$Obra','$Cliente','$FechaInicio','$Valor','$Concepto','$Usuario','$Estado')"; 
				$result3=mysql_query($query3,$id);
			}
		}
			else{

				if(($FechaAnterior=$FechaActual) && ($FechaProxima<=$FechaFin)){
				...
				VALUES ('$IdCuenta','$FechaProxima','$FechaDesp','$Cuota')";
				...
				$query5.= "VALUES ('1','$Opcion','$Idobra','$Idcliente','$Obra','$Cliente','$FechaProxima','$Valor','$Concepto','$Usuario','$Estado')"; 
				...
				$query5="INSERT INTO  CuentasCobrar (TipoCuenta,Opcion,Idobra,Idcliente,Obra,Cliente,FechaInicio,Valor,Concepto,Usuario,Estado)";
				$query5.= "VALUES ('1','$Opcion','$Idobra','$Idcliente','$Obra','$Cliente','$FechaProxima','$Valor','$Concepto','$Usuario',1)"; 
				$result5=mysql_query($query5,$id);
				}
			}
}

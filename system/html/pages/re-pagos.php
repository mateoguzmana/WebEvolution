			...
			<div id="content">
				<section>
					<div class="section-header">
						<h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> Cuentas por pagar</h3>
					</div>
								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Re-utilizar Cuenta por Pagar</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
															...
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione una Obra" style="background-color:#CCC" <?=$ponebloqueo?>>
                                                                  ...
                                                                  <option value="act-pagos-2.php?Id=<?=$IdPago?>&Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Obra?></option>
																		...
																		$queryFOX 		="SELECT * FROM Proyectoprov WHERE  Proveedor='$ese' ";
																		$resultFOX		=mysql_query($queryFOX,$id);

																		while ($rowFOX=mysql_fetch_array($resultFOX)) {
																		$ObraX 			=$rowFOX["Idproyect"];

																		$queryTIP		="SELECT * FROM Proyectos where Muestra = 0 and Id <> '$Idobra' and Id='$ObraX' order by Nombre";
...
FECHA ANULACIÓN: <?=$FechaAnulacion?>&nbsp;&nbsp;|&nbsp;&nbsp;USUARIO: <?=$NombreUsuario?></textarea>
													...
													<div class="form-group">
														<div class="col-lg-11 col-md-10 col-sm-9">
															<br/><br/><button type="submit" id="enviar" class="btn btn-support5">Realizar Operación</button>
															<input name="Volver" type="button" class="btn btn-warning" value="Volver"  onClick="location.href='act-pagos-2.php?Id=<?=$IdPago?>&Idmenu=7&Idsubmenu=14&Idopcmenu=20'">
														</div>
													</div>

	...
	*/
	function addlinkmsg ($tp,$rs,$rt,$type = null) {
		...
		if($this->linkTitulo === true) {
			switch($type) {
				case 1: return "Primera Pagina. Resultados del $rs al $rt de $total"; break;
				case 2: return "Pagina anterior: Resultados del $rs al $rt de $total"; break;
				case 3: return "Pagina $tp: Resultados del $rs al $rt de $total"; break; // Corregido version 2.0
				case 4: return "Pagina siguiente. Resultados del $rs al $rt de $total"; break;
				case 5: return "&Ultima Pagina. Resultados del $rs al $rt de $total"; break;

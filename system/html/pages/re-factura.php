...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					$nuevafecha	=(string)(int)$nuevafecha;
					 ...
					 While($rowUSERS	=mysql_fetch_array($resultUSERS))
					 {
						...
						if ($Recurrente==0) {
						$formx="add-factura-2.php";
						}
						elseif($Recurrente==1){
						$formx="add-factura-recu-2.php";	
						}
						else{
						$formx="";	
						}
			...
			<div id="content">
				<section>
					<div class="section-header">
						<h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> Re-utilizar Factura</h3>
					</div>
								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Re-utilizar Factura</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" id="form1" name="form1" action="<?=$formx?>" novalidate>
                                                        <?
														}
														else
														{
													...
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione el Cliente" style="background-color:#CCC" readonly <?=$ponebloqueo?>>
																...
																<div class="col-sm-6">
																	<div class="form-group">
																		<div class="col-lg-2 col-md-4 col-sm-6">
																			...
																			<div class="col-lg-10 col-md-8 col-sm-6">
																			<input type="hidden" name="Recurrente" value="<?=$Recurrente?>">
																			<select name="Periodicidad" id="Periodicidad" class="form-control select2-list" required>
                                                                        		<option value="<?=$DiaPer?>" selected><?=$NombrePer?></option>
...
?> 
															<input name="Reutilizar" type="submit" class="btn btn-support5" value="Realizar operación">
															<input name="Volver" type="button" class="btn btn-default" value="Volver"  onClick="location.href='act-factura-2.php?Idcliente=<?=$Idcliente?>&Id=<?=$Idfact?>&Idsubmenu=<?=$_REQUEST["Idsubmenu"]?>&Idmenu=<?=$_REQUEST["Idmenu"]?>&Idopcmenu=<?=$_REQUEST["Idopcmenu"]?>'">
														</div>
													</div>

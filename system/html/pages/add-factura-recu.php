...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-factura-recu-2.php" id="form1" name="form1" novalidate>
                                                        <?
														}
														else
														{
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione el Cliente" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="add-factura-recu.php?Idcliente=<?=$Idcliente?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Nombreclien?></option>
                                                                        <?
																		}
																		else
																		{
																		?>
                                                                        <option value="add-factura-recu.php" selected>Seleccione el Cliente</option>
                                                                        <?
																		}
                                                                        ...
                                                                        ?>
                                                                        <option value="add-factura-recu.php?Idcliente=<?=$IdTIP?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$NombreTIP?></option>
																		<?
																		}
																		?>

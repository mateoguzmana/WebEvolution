						...
						<div class="row">
							...
							$MosPerzB			=$rowPerz1["Del"];
								...
								$MosPerz2	=	1;
                                                ...
                                                $queryUSERS			="SELECT* FROM Proyectos where Muestra = 0 Order by Id DESC";
												...
												<tr class="gradeA">
													...
													<td class="text-right">
														...
														{
														?>                                              
													<input name="Procesar" type="button" class="btn btn-primary" style="width:100px;" value="MODIFICAR"  onClick="location.href='act-proyecto-2.php?Id=<?=$IdUSERS?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'"> 
                                                        <?
														}
														else
														{
														?>
													<input name="Procesar" type="button" class="btn btn-warning" style="width:100px;" value="FINALIZADA"  onClick="location.href='act-proyecto-2.php?Id=<?=$IdUSERS?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'"> 
                                                        <?
														}

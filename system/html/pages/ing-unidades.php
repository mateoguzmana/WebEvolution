								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Ingresar unidades</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
															...
															<div class="form-group">
                                                              <div class="col-sm-12">
																<label for="Nombre" class="control-label">Nombre</label>
																	<input type="text" name="Valor" id="Valor" class="form-control" placeholder="Ingrese un Valor" onChange="javascript:this.value=this.value.toUpperCase();" required>
																</div>
															</div>
														</div>
														<div class="col-sm-6">

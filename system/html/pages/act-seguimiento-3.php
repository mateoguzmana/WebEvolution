...
$Id 					= 	$_REQUEST["Id"];
					...
					$queryUSERS			="SELECT * FROM Seguimiento WHERE Id='$Id' AND Muestra=0 Order by Id DESC";
					...
					$queryKK		="SELECT* FROM Clientes where Id='$Idcliente' order by Nombre";
								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Ingresar seguimiento cliente</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="act-seguimiento-4.php" enctype="multipart/form-data" novalidate>
                                                        <?
														}
														else
														{
												...
												<form class="form-horizontal form-validate" role="form" method="post"  novalidate>
													...
													<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="Cliente" id="Cliente" class="form-control" required data-placeholder="Seleccione el Cliente">
                                                                        <option value="<?=$Idcliente?>" selected><?=$Cliente?></option>
                                                                        <? /*
														...
														<div class="form-group">
															<div class="col-sm-12">
																...
																<div class='input-group date' id='demo-date-start'>
																	<input type="text" class="form-control" placeholder="Fecha del seguimiento" value="<?=$Fecha?>" required name="Fecha" id="Fecha"/>
														...
														<div class="form-group">
																<div class="col-sm-12">
																  <label for="Detalles" class="control-label">Detalles</label>
                                                       	          <textarea name="Detalles" rows="3" required class="form-control" id="Detalles" placeholder="Detalles del seguimiento" onChange="javascript:this.value=this.value.toUpperCase();"><?=$Detalles?></textarea>
																</div>
														</div>
													</div>
													...
													<div class="col-sm-6">
														<div class="form-group">
															<div class="col-sm-12">
																<label for="Archivo" class="control-label">&nbsp;</label><br>
																	<a href="clientes/<?=$Idcliente?>/<?=$Archivo?>" download="clientes/<?=$Idcliente?>/<?=$Archivo?>"> (Descargar archivo) <i class="fa fa-download"></i></a>
                                                            </div>
														</div>
													</div>
													<?}?>

			...
			<div id="content">
				<section>
					<div class="section-header">
						<h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> Ingresar</h3>
					</div>
								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Ingresar prospecto</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="ing-prospecto-2.php" id="form1" name="form1" novalidate>
                                                        <?
														}
														else
														{
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione el Cliente" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="ing-prospecto.php?Idcliente=<?=$Idcliente?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Nombreclien?></option>
                                                                        <?
																		}
																		else
																		{
																		?>
                                                                        <option value="ing-prospecto.php" selected>Seleccione el Cliente</option>
                                                                        <?
																		}
                                                                        ...
                                                                        ?>
                                                                        <option value="ing-prospecto.php?Idcliente=<?=$IdTIP?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$NombreTIP?></option>
																		<?
																		}
																		?>
														...
														<div class='input-group date' id='demo-date-start'>
															...
															<div class="form-group">
																<div class="col-sm-12">
                                                                  ...
                                                                  <textarea name="Observaciones" rows="3" required class="form-control" id="Observaciones" placeholder="Observaciones del prospecto" onChange="javascript:this.value=this.value.toUpperCase();"></textarea>
																</div>
															</div>

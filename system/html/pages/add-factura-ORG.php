													...
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control btn-support1" onChange="MM_jumpMenu('parent',this,0)" data-placeholder="Seleccione el Cliente" >
...
?>
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                	<input type="text" name="Ubicacion" id="Nit" class="form-control" placeholder="Nit del Cliente" value="<?=$Nitclien?>" readonly style="background-color:#DDF0C1">
																</div>
															</div>
														</div>
...
?>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                	<input type="text" name="Direccion" id="Direccion" class="form-control" placeholder="Direccion del Cliente" value="<?=$Dirclien?>" readonly style="background-color:#DDF0C1">
																</div>
															</div>
														</div>
														...
														<div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input type="text" class="form-control" name="Ciudad" id="Ciudad" value ="<?=$Ciudadclien?>" placeholder="Ciudad del Cliente" readonly style="background-color:#DDF0C1">
                                                                </div>
                                                            </div>
														</div>
...
<div class="row"> 
                        ...
                        <div class="control-group">
                                ...
                                <table width="100%" border="1" class="btn-support3" style="font-size:10px; font-weight:bold;">
                                  <tr>
                                    <td width="10%">&nbsp;CANT.</td>
                                    <td width="15%">&nbsp;</td>
                                    ...
                                    <a id="agregarCampo" class="btn btn-info" href="#" style="border:0px;"><img src="../../assets/img/add.png" border= "0"></a></td>
                                  </tr>
                                </table>
                          										</div>
                        </div> 
    ...
    <div id="contenedor">
    <div class="added">
        <input type="text" name="cant1" id="cant1" placeholder="CANT 1" style="width:9%; font-size:9px;"/>&nbsp;<input type="text" name="plano1" id="plano1" placeholder="<?=$poner?> 1" style="width:14%; font-size:9px;" />&nbsp;<input type="text" name="descri1" id="descri1" placeholder="DESCRIPCIÓN 1" style="width:54%; font-size:9px;"/>
        <a href="#" onClick="window.open('lista-precios.php?Cont=1','precios','menubar=no,scrollbars=yes, width=600, height=600');return false"><img src="../../assets/img/buscar.gif" boder = "0"></a> &nbsp;<input type="text" name="vlr1" id="vlr1" placeholder="V/UNID 1" style="width:8%; font-size:9px;" onKeyUp="puntitos(this,this.value.charAt(this.value.length-1));"/>
        <a href="#" class="eliminar"><img src="../../assets/img/delete.png" border = "0" style="margin-left:5px;"></a>
...
$(document).ready(function() {
    ...
    $(AddButton).click(function (e) {
        if(x <= MaxInputs) //max input box allowed
        {
            ...
            //agregar campo
            $(contenedor).append('<div><input type="text" name="cant'+ FieldCount +'" id="cant'+ FieldCount +'" placeholder="CANT '+ FieldCount +'" style="width:9%; font-size:9px;"/>&nbsp;<input type="text" name="plano'+ FieldCount +'" id="plano'+ FieldCount +'" placeholder="<?=$poner?> '+ FieldCount +'" style="width:14%; font-size:9px;"/>&nbsp;<input type="text" name="descri'+ FieldCount +'" id="descri'+ FieldCount +'" placeholder="DESCRIPCION '+ FieldCount +'" style="width:52%; font-size:9px;"/> <a href="#" onClick="window.open(&quot;lista-precios.php?Cont='+ FieldCount +'&quot;,&quot;precios&quot;,&quot;menubar=no,scrollbars=yes, width=600, height=600&quot;);return false"> <img src="assets/img/buscar.gif" boder = "0"></a> &nbsp;<input type="text" name="vlr'+ FieldCount +'" id="vlr'+ FieldCount +'" placeholder="V/UNID '+ FieldCount +'" style="width:8%; font-size:9px;" onKeyUp="puntitos(this,this.value.charAt(this.value.length-1));"/> <a href="#" class="eliminar"><img src="../../assets/img/delete.png" border = "0" style="margin-left:5px;"></a></div>');

														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="text" name="Nombre" id="Nombre" class="form-control" placeholder="Nombre del tipo de retención" value="" onChange="javascript:this.value=this.value.toUpperCase();" required>
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="text" name="Valor" id="Valor" class="form-control" placeholder="Porcentaje de la retención %" required>
																</div>
															</div>
														</div>
													</div>

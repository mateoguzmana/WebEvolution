...
$sql="INSERT INTO  Facturacion (Idcliente,Idobra ,Razon, Nit, Direccion, Ciudad, Fechafact, Fechalim, Descripcion, IvaTemp,Retencion, ReteICA,Fecha, Usuario)";
$sql.= "VALUES ('$Idcliente','$Obra','$Razon','$Nit','$Direccion','$Ciudad','$Fechafact','$Fechalim','$Descripcion','$IvaK','$Retencion','$ReteICA','$horaactual','$Usuario')";
mysql_query($sql);

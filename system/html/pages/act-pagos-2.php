...
?>
												...
												<div class="col-sm-12">
													...
													<input type="text" name="NumeroFactura" <?=$ponebloqueo?> id="NumeroFactura" class="form-control" value="<?=$NumeroFactura?>">
...
FECHA ANULACIÓN: <?=$FechaAnulacion?>&nbsp;&nbsp;|&nbsp;&nbsp;USUARIO: <?=$NombreUsuario?></textarea>
													...
													<div class="form-group">
														<div class="col-lg-11 col-md-10 col-sm-9">
															...
															<?}?>
															<input name="Reutilizar" type="button" class="btn btn-support5" value="Re-utilizar"  onClick="location.href='re-pagos.php?Id=<?=$IdPago?>&Idmenu=7&Idsubmenu=14&Idopcmenu=20'">

...
?>
												...
												<form class="form-horizontal form-validate" role="form" method="post"  novalidate>
													...
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																<label for="Hosting" class="control-label">Hosting y dominio</label>
																<select name="Hosting" id="HostingDominio" class="form-control select2-list" onchange="muestra()" data-placeholder="Seleccione el Hosting" required>
											...
											<div class="row">
												<div id="Hosting" style="display:none;">
													...
													<hr style="color:black;height:0.5px;background-color:black;" width="90%">
												  ...
												  <div class="col-sm-12">
													...
													<div class="col-sm-12">
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Fecha Origen" class="control-label">Fecha Origen</label>
                                                                    <div class='input-group date' id='demo-date-start'>
                                                                        <input type="text" name="FechaOrigenH" class="form-control" id='demo-date-inline' placeholder="Fecha de inicio" required data-date-format="yyyy-mm-dd"/>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Fecha Vence" class="control-label">Fecha Vence</label>
                                                                    <div class='input-group date' id='demo-date-end'>
                                                                        <input type="text" name="FechaVenceH" class="form-control" id='demo-date-inline' placeholder="Fecha de vencimiento" required data-date-format="yyyy-mm-dd"/>
                                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                    </div>
                                                                </div>
															</div>
													...
													<div class="col-sm-12">
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Fecha Vence" class="control-label">Empresa</label>
                                                                        <input type="text" name="EmpresaH" class="form-control"  placeholder="Empresa hosting" required data-date-format="yyyy-mm-dd"/>
                                                                 </div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Fecha Vence" class="control-label">Usuario</label>
                                                                        <input type="text" name="UsuarioH" class="form-control" placeholder="Usuario hosting" required data-date-format="yyyy-mm-dd"/>
                                                                </div>
															</div>
														</div>
													</div>
													<div class="col-sm-12">
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Fecha Vence" class="control-label">Contraseña</label>
                                                                        <input type="text" name="ContrasenaH" class="form-control" placeholder="Contraseña hosting" required data-date-format="yyyy-mm-dd"/>
                                                                </div>
															</div>
														</div>
													</div>
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-12">
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Fecha Vence" class="control-label">Fecha Origen</label>
                                                                    <div class='input-group date' id='demo-date-uno'>
                                                                        <input type="text" name="FechaOrigenD" class="form-control" id='demo-date-inline' placeholder="Fecha de inicio" required data-date-format="yyyy-mm-dd"/>
                                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                    </div>
                                                                </div>
															</div>
															...
															<div class="form-group">
																<div class="col-sm-12">
                                                                    ...
                                                                    <div class='input-group date' id='demo-date-dos'>
                                                                        <input type="text" name="FechaVenceD" class="form-control" id='demo-date-inline' placeholder="Fecha de vencimiento" required data-date-format="yyyy-mm-dd"/>
                                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                    </div>
                                                                </div>
															</div>
													...
													<div class="col-sm-12">
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Fecha Vence" class="control-label">Empresa</label>
                                                                        <input type="text" name="EmpresaD" class="form-control" placeholder="Empresa dominio" required data-date-format="yyyy-mm-dd"/>
                                                                </div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Fecha Vence" class="control-label">Usuario</label>
                                                                        <input type="text" name="UsuarioD" class="form-control" placeholder="Usuario dominio" required data-date-format="yyyy-mm-dd"/>
                                                                </div>
															</div>
														</div>
													</div>
													<div class="col-sm-12">
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Fecha Vence" class="control-label">Contraseña</label>
                                                                        <input type="text" name="ContrasenaD" class="form-control" placeholder="Contraseña dominio" required data-date-format="yyyy-mm-dd"/>
                                                                </div>
															</div>
														</div>
													</div>
														...
														<!--<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="text" name="Usuario" id="Usuario" class="form-control" placeholder="Cedula" required>
																</div>
															</div>
														</div>-->
													</div>
